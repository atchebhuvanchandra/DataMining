...
count = 0
file=open('C:/Users/BHUVAN/Desktop/study zone/DataMinig/SentimentA/OhioSenate1.json','a')
for tweet in tweepy.Cursor(api.search,q="#SherrodBrown OR #OhioSen OR #OhioPrimary OR #Demsherrodbrown",lang="en").items():
